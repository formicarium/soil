...
#_(defn json->str [coll] (cheshire/generate-string coll))

#_(defn str->json [str] (cheshire/parse-string str true))


#_(defn create-env-req! [service] (response-for service
                                              :post "/api/devspaces"
